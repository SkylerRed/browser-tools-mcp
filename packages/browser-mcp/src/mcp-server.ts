...
import { registerLoggingTools, registerAuditTools, registerBrowserTools, registerModeTools } from "./tools/index.js";

// Register all tools
registerLoggingTools(server, withServerConnection, discoveredHost, discoveredPort);
registerAuditTools(server, withServerConnection, discoveredHost, discoveredPort);
registerBrowserTools(server, withServerConnection, discoveredHost, discoveredPort);
